...
const showGoldPlan = false
const showPlatinumPlan = true
...
<template>
  <div>
    ...
    <header class="navbar bg-base-100/90 backdrop-blur-md fixed top-0 left-0 right-0 z-50 border-b border-white/5" role="banner">
      <div class="container mx-auto px-4">
        ...
        <nav class="flex-none hidden lg:flex gap-8 mr-6" role="navigation" aria-label="Menu principale">
          ...
          <a href="#pricing" class="text-sm font-medium text-white hover:text-white/80 transition">Prezzi</a>
    ...
    <main id="main-content" role="main">
      ...
      <!-- THAI PRO PRICING SECTION -->
      <section id="pricing" class="py-16 sm:py-24 bg-base-300 relative overflow-hidden" aria-labelledby="pricing-title">
        <!-- Background decorations -->
        <div class="absolute inset-0 opacity-20" aria-hidden="true">
          <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-amber-500 rounded-full mix-blend-screen filter blur-[150px]"></div>
          <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500 rounded-full mix-blend-screen filter blur-[150px]"></div>
        </div>

        <div class="container mx-auto px-4 sm:px-6 relative z-10">
          <div class="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            <!-- Pro Badge -->
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.2), rgba(255, 165, 0, 0.2)); border: 1px solid rgba(255, 215, 0, 0.4);">
              <svg class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/>
              </svg>
              <span class="text-amber-400 font-semibold text-sm"><span class="font-brand">ThAi</span> Pro</span>
            </div>

            <h2 id="pricing-title" class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-white">
              Scegli il piano perfetto per te
            </h2>
            <p class="text-lg sm:text-xl text-white/90">
              Dalla prova alla gestione completa della salute di tutta la famiglia.<br>
              <strong class="text-white">Investi meno di un caffè al mese nella tua tranquillità.</strong>
            </p>
          </div>
          ...
          <div class="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <!-- FREE Plan -->
            <article class="google-card p-6 sm:p-8 relative">
              <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p class="text-white/80 text-sm">Per iniziare</p>
                </div>
              </div>

              <div class="mb-6">
                <span class="text-3xl font-bold text-white/90">0€</span>
                <span class="text-white/80">/sempre</span>
              </div>
              ...
              <ul class="space-y-3 mb-8">
                <li class="flex items-center gap-3 text-white/90">
                  ...
                  <span>1 paziente</span>
                </li>
                <li class="flex items-center gap-3 text-white/90">
                  <svg class="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                  </svg>
                  <span>3 analisi AI / settimana</span>
                </li>
                <li class="flex items-center gap-3 text-white/90">
                  <svg class="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                  </svg>
                  <span>9 messaggi chat / settimana</span>
                </li>
                <li class="flex items-center gap-3 text-white/90">
                  <svg class="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                  </svg>
                  <span>Categorie illimitate</span>
                </li>
                <li class="flex items-center gap-3 text-white/90">
                  <svg class="w-5 h-5 text-white/80 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                  </svg>
                  <span>Con pubblicit&agrave;</span>
                </li>
              </ul>

              <p class="text-center text-white/80 text-sm">Perfetto per provare l'app</p>
            </article>

            <!-- GOLD Plan -->
            <article
              v-if="showGoldPlan"
              class="google-card p-6 sm:p-8 relative"
              style="background: linear-gradient(135deg, rgba(255, 215, 0, 0.08), rgba(255, 165, 0, 0.05)); border: 1px solid rgba(255, 215, 0, 0.3);"
            >
              <div class="flex items-center gap-3 mb-4">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center" style="background: rgba(255, 215, 0, 0.2);">
                  <svg class="w-6 h-6 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/>
                  </svg>
                </div>
                <div>
                  <h3 class="text-2xl font-bold text-amber-400">Gold</h3>
                  <p class="text-amber-400/70 text-sm">Per famiglie</p>
                </div>
              </div>

              <div class="mb-6">
                <span class="text-4xl font-bold text-white">9,99€</span>
                <span class="text-white/90">/anno</span>
                <p class="text-amber-400/80 text-sm mt-1">Solo 0,83€ al mese</p>
              </div>
              ...
              <ul class="space-y-3 mb-8">
                <li class="flex items-center gap-3 text-white">
                  ...
                  <span><strong>3 pazienti</strong></span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>5 analisi AI</strong> / mese</span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>25 messaggi chat</strong> / mese</span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>5 categorie</strong></span>
                </li>
              </ul>

              <p class="text-center text-amber-400/80 text-sm font-medium">Ideale per te e i tuoi cari</p>
            </article>

            <!-- PLATINUM Plan (Recommended) -->
            <article
              v-if="showPlatinumPlan"
              class="relative p-6 sm:p-8 rounded-3xl"
              style="background: linear-gradient(135deg, #6366F1, #8B5CF6); box-shadow: 0 25px 50px -12px rgba(99, 102, 241, 0.5);"
            >
              <!-- Recommended Badge -->
              <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div class="px-4 py-1.5 rounded-full text-xs font-bold" style="background: linear-gradient(135deg, #FFD700, #FFA500); color: #000;">
                  ⭐ CONSIGLIATO
                </div>
              </div>
              ...
              <div class="flex items-center gap-3 mb-4 mt-2">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center bg-white/20">
                  <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19,5H17V3H7V5H5A2,2 0 0,0 3,7V8L5.74,13.45C6.42,14.74 7.72,15.5 9.13,15.5H14.87C16.28,15.5 17.58,14.74 18.26,13.45L21,8V7A2,2 0 0,0 19,5M12,14A3,3 0 0,1 9,11A3,3 0 0,1 12,8A3,3 0 0,1 15,11A3,3 0 0,1 12,14M12,10A1,1 0 0,0 11,11A1,1 0 0,0 12,12A1,1 0 0,0 13,11A1,1 0 0,0 12,10M5,19H19V21H5V19Z"/>
                  </svg>
                </div>
                <div>
                  <h3 class="text-2xl font-bold text-white">Platinum</h3>
                  <p class="text-white/70 text-sm">Senza limiti</p>
                </div>
              </div>

              <div class="mb-6">
                <span class="text-4xl font-bold text-white">19,99€</span>
                <span class="text-white/70">/anno</span>
                <p class="text-white/80 text-sm mt-1">Solo 1,67€ al mese</p>
              </div>
              ...
              <ul class="space-y-3 mb-8">
                <li class="flex items-center gap-3 text-white">
                  ...
                  <span><strong>Pazienti illimitati</strong></span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>Analisi AI illimitate</strong></span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>Chat illimitata</strong></span>
                </li>
                <li class="flex items-center gap-3 text-white">
                  <svg class="w-5 h-5 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                  </svg>
                  <span><strong>Categorie illimitate</strong></span>
                </li>
              </ul>

              <p class="text-center text-white/90 text-sm font-medium">La scelta completa per la tua salute</p>
            </article>
          ...
          <div class="mt-12 text-center">
            <p class="text-white/80 text-sm mb-4">Pagamento sicuro · Annulla quando vuoi · Nessun rinnovo automatico nascosto</p>
            <div class="flex flex-wrap gap-6 justify-center items-center text-white/90">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm">Pagamenti via App Store / Google Play</span>
              </div>
            </div>
          </div>
        </div>
